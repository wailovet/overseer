...
[![GoDoc](https://godoc.org/github.com/wailovet/overseer?status.svg)](https://godoc.org/github.com/wailovet/overseer)
...
```sh
go get github.com/wailovet/overseer
```
...
See [Config](https://godoc.org/github.com/wailovet/overseer#Config)uration options [here](https://godoc.org/github.com/wailovet/overseer#Config) and the runtime [State](https://godoc.org/github.com/wailovet/overseer#State) available to your program [here](https://godoc.org/github.com/wailovet/overseer#State).
...
* [Core `overseer` package](https://godoc.org/github.com/wailovet/overseer)
* [Common `fetcher.Interface`](https://godoc.org/github.com/wailovet/overseer/fetcher#Interface)
	* [File fetcher](https://godoc.org/github.com/wailovet/overseer/fetcher#File)
	* [HTTP fetcher](https://godoc.org/github.com/wailovet/overseer/fetcher#HTTP)
	* [S3 fetcher](https://godoc.org/github.com/wailovet/overseer/fetcher#S3)
	* [Github fetcher](https://godoc.org/github.com/wailovet/overseer/fetcher#Github)
